...
<<<<<<< HEAD:bot_core/bot.ts

        telegramCommands.setWebhook("https://busta-chatbots.ue.r.appspot.com/", this.botKey);
=======
        this.initialized = true;
>>>>>>> f207f05... WIP refactor. Update package scripts, add telegram api types, refactor classes to use the provided complete types for the api.:bot_core/Bot/bot.ts
    };
